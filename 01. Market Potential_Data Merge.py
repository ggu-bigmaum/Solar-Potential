...
calc_reject = ['배제28종(1-26+6m폭도로100m버퍼+철도)'
            ...
            #  ,'영농형_reverse' 사용X
              ,'r_1_25_rail_진흥지역내_배제_농지'  #-- 배제면적이 아닌 잠재량 (사용X)
              ,'r_1_25_rail_진흥지역외_배제_농지'  #-- 배제면적이 아닌 잠재량 (사용X)
              ,'r_1_25_rail_rd100_res200_진흥지역내_배제_농지' #-- 배제면적이 아닌 잠재량 (사용X)
              ,'r_1_25_rail_rd100_res200_진흥지역외_배제_농지' #-- 배제면적이 아닌 잠재량 (사용X)
              ,'r_1_25_rail_rd200_res300_진흥지역내_배제_농지' #-- 배제면적이 아닌 잠재량 (사용X)
              ,'r_1_25_rail_rd200_res300_진흥지역외_배제_농지'  #-- 배제면적이 아닌 잠재량 (사용X)
             ]   
